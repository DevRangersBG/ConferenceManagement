            ...
            <div class="shadow-sm sm:rounded-lg">
                ...
                style="background-image: url('http://stilyan0901.infinityfreeapp.com/Rakovski.jpg');">
                            ...
                            <div class=" opacity py-4 max-w-md mx-auto mt-10 bg-white  shadow-lg rounded-lg overflow-hidden">
                                <div class=" opacityblue text-2xl py-4 px-6 bg-blue-500 text-gray-200 text-center font-style: italic uppercase">
                                           Participation form
                                        </div>
                                    <form class=" py-4 px-6" action="" method="GET">
                                        ...
                                        <div class="relative z-0 w-full mb-5 group">
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                               ...
                                               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-yellow-600 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone number
                                               </label>
                                            </div>
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                              ...
                                              class="block py-2.5 px-0 w-full text-sm text-gray-500 dark:text-yellow-600">I will participate in the conference as:</label>
                                              <select id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-yellow-600 dark:border-yellow-600 focus:outline-none focus:ring-0 focus:border-yellow-600 peer">
                                    ...
                                    <form class="py-4 px-6" action="" method="GET">
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                               ...
                                               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-yellow-600 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Report/article title in Bulgarian language:
                                               </label>
                                            </div>
                                            
                                                  <!--Attach report -->
                                            <div class="relative z-0 w-full mb-5 group">
                                                <p class="mt-1 text-sm text-gray-500 dark:text-yellow-600" id="file_input_help">Attach your report/article (for authors only, up to 2 MB) in Word</p>
                                                <label for="uploadFile1"
                                                       ...
                                                       <svg xmlns="http://www.w3.org/2000/svg" class="w-8 mb-6 fill-yellow-600" viewBox="0 0 24 24">
                                                           <path
                                                       ...
                                                       <p class="text-yellow-600 font-semibold text-sm">Drag & Drop or <span class="text-[#4eb2ec]">Choose file</span> to
                                                           upload</p>
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                                <p class="mt-1 text-sm text-gray-500 dark:text-yellow-600" id="file_input_help">Abstract of the report in Bulgarian language, 100 to 150 words (mandatory for authors):</p>
                                                <textarea class="opacity custom-textarea"></textarea>

                                            </div>
                                                   <!--Keywords -->
                                            <div class="relative z-0 w-full mb-5 group">
                                                <p class="mt-1 text-sm text-gray-500 dark:text-yellow-600" id="file_input_help">Keywords (mandatory for authors):</p>
                                                <textarea class=" opacity custom-textarea"></textarea>
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                              <form class="max-w-sm mx-auto">
                                              <label for="participants"
                                              class="block py-2.5 px-0 w-full text-sm text-gray-500 dark:text-yellow-600">Thematic areas you wish to participate in:</label>
                                              <select id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-yellow-600 dark:border-yellow-600 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                            ...
                                            <div class="relative z-0 w-full mb-5 group">
                                              <form class="max-w-sm mx-auto">
                                              <label for="participants"
                                              class="block py-2.5 px-0 w-full text-sm text-gray-500 dark:text-yellow-600">Do you wish to receive a certificate of participation in the conference?:</label>
                                              <select id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-yellow-600 dark:border-yellow-600 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                                            ...
                                            <div class="flex flex-col items-center">
                                              ...
                                              <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-yellow-600 rounded-md group-hover:bg-opacity-0">
                                              SUBMIT
                                              </span>
                                              </button>
                                            </div>
